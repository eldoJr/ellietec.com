...
const getGlowColor = () =>
  getComputedStyle(document.documentElement).getPropertyValue('--glow-color').trim() || '#03060f'
...
const DotField = memo(({
  ...
  useEffect(() => {
    ...
    function tick() {
      ...
      const fromColor = isDark ? 'rgba(255,255,255,0.12)' : 'rgba(251,76,30,0.45)'
      const toColor   = isDark ? 'rgba(255,255,255,0.04)' : 'rgba(251,76,30,0.15)'
